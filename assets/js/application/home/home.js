...
$.ajax({
  ...
  success: function(data) {
    ...
    myLineChart3.data.labels.push(label);
    ...
    myLineChart3.data.datasets[0].data = meninggal;
    myLineChart3.data.datasets[1].data = positif;
    myLineChart3.data.datasets[2].data = sembuh;
    myLineChart3.data.datasets[3].data = odp;
    myLineChart3.data.datasets[4].data = pdp;
