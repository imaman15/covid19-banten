...
$.ajax({
	...
	success: function (data) {
		...
		$.each(data, function (i, item) {
			...
			var count_positif = item.tot_positif;
			var count_sembuh = item.tot_sembuh;
			var count_odp = item.tot_odp;
			var count_pdp = item.tot_pdp;
			var count_meninggal = item.tot_meninggal;
